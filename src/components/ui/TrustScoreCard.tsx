 ...
 * green and the star shapes are kept intact — that brand recognition is what
 * gives the social proof its weight, so we don't recolor it to gold.
 *
...
export function TrustScoreCard() {
  return (
    <div className="mx-auto w-full max-w-sm rounded-2xl border border-accent/15 bg-cream p-6 text-forest-900 shadow-[0_20px_50px_-20px_rgba(0,0,0,0.6)]">
      ...
      <a
        ...
        className="block rounded-full border border-forest-900/20 py-2.5 text-center text-sm font-semibold text-forest-900 transition-colors hover:border-forest-900/40 hover:bg-forest-900/5"
      >
