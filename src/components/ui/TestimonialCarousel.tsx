 ...
 * trackpad and keyboard out of the box) with gold arrow controls that nudge
    ...
    <div className="relative">
      ...
      >
        {items.map((src, i) => (
          <li
            key={i}
            className="w-[85vw] max-w-[420px] shrink-0 snap-center overflow-hidden rounded-2xl border border-accent/15 bg-cream shadow-[0_20px_50px_-20px_rgba(0,0,0,0.6)] sm:w-[380px]"
          >
            <Image
              src={src}
